...
const ChatPannel = ({
  ...
  return (
    <aside className="w-full sm:w-80 h-full bg-white border border-slate-200 flex flex-col z-20 shadow-2xl animate-in slide-in-from-right duration-200">
          ...
          messages.map((msg, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Message */}
                <div
                  className={`px-3 py-2.5 rounded-2xl max-w-[85%] text-sm leading-relaxed shadow-xs ${
                    isMe
